...
Un primer prototipo se implemento enteramente en CLIPS. Antes de entrar en los detalles haré 
una breve introducción aclips.  
...
el resto podrán estar presentes o no. Ya se verá que desde la interfaz administrativa se puede controlar
cúales de un conjunto de características se desean incorporar en la base de conocimiento. 
...
La insterfaz administrativa permite agregar nuevo equipamiento a la base de datos. Y cambiar
...
\section{Resumen de las herramientas utilizadas}

\subsection{Selección de las herramientas}

La herramientas necesarias para el desarrollo y documentación del sistema ha sido varias.
...
El diseño funcional de la interfa administrativa se hizo usando 
Webratio: WebML
