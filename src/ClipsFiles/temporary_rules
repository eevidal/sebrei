...
(printer (id 32)(model "LaserJet_Pro_400_color_M475dw_MFP" )(tecnology laser)(type multifuncion) (conectivity ethernet usb wifi) (functions imprimir escanear fax copiar)(color si)(duplex si)(use profesional pyme)(tag gran_inversion gran_inversion)(a3 no))
...
(printer (id 35)(model "LaserJet_Pro_400_Color_PrinterM45dw" )(tecnology laser)(type impresora) (conectivity ethernet usb wifi) (functions imprimir)(color no)(duplex si)(use profesional pyme)(tag alto alto)(a3 no))
...
(printer (id 47)(model "Color_LaserJet_Enterprise_CM4540f_MFP" )(tecnology laser)(type multifuncion) (conectivity ethernet usb) (functions imprimir escanear fax copiar envio digital)(color si)(duplex si)(use pyme pyme+)(tag gran_inversion gran_inversion)(a3 no))
...
(printer (id 49)(model "LaserJet_Enterprise500_M525f_MFP" )(tecnology laser)(type multifuncion) (conectivity ethernet usb) (functions imprimir escanear fax copiar envio digital)(color no)(duplex si)(use pyme pyme)(tag gran_inversion gran_inversion)(a3 no))

(printer (id 51)(model "LaserJet_5200tn" )(tecnology laser)(type impresora) (conectivity usb   ) (functions imprimir)(color no)(duplex no)(use pyme pyme+)(tag gran_inversion gran_inversion)(a3 no))

(printer (id 53)(model "LaserJet_Enterprise_M4555f_MFP" )(tecnology laser)(type multifuncion) (conectivity ethernet usb ) (functions imprimir escanear fax copiar envio digital)(color no)(duplex si)(use pyme corporativo)(tag gran_inversion gran_inversion)(a3 no))

(printer (id 54)(model "LaserJet_M5035xs_MFP" )(tecnology laser)(type multifuncion) (conectivity usb  ) (functions imprimir escanear fax copiar envio digital)(color no)(duplex si)(use pyme corporativo)(tag gran_inversion gran_inversion)(a3 si))

(printer (id 55)(model "LaserJet_M9050_MFP" )(tecnology laser)(type multifuncion) (conectivity   ) (functions imprimir escanear fax copiar envio digital)(color no)(duplex si)(use corporativo corporativo)(tag gran_inversion gran_inversion)(a3 si))

(printer (id 56)(model "HL-4150CDN" )(tecnology laser)(type impresora) (conectivity ethernet usb) (functions imprimir)(color si)(duplex si)(use hogar profesional pyme)(tag alto alto)(a3 no))
