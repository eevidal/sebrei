...
SELECT pg_catalog.setval('cartridge_cartridge_id_seq', 4, true);
...
SELECT pg_catalog.setval('language_language_id_seq', 3, true);
...
SELECT pg_catalog.setval('paper_paper_id_seq', 1, true);
...
CREATE TABLE printer (
    ...
    printer_velocity velocity[] NOT NULL,
...
SELECT pg_catalog.setval('quality_quality_id_seq', 13, true);
...
SELECT pg_catalog.setval('sheet_sheet_id_seq', 18, true);
...
SELECT pg_catalog.setval('so_so_id_seq', 3, true);
...
ALTER TABLE cartridge ALTER COLUMN cartridge_id SET DEFAULT nextval('cartridge_cartridge_id_seq'::regclass);
...
ALTER TABLE conectivity ALTER COLUMN conectivity_id SET DEFAULT nextval('conectivity_conectivity_id_seq'::regclass);
...
ALTER TABLE direct ALTER COLUMN direct_id SET DEFAULT nextval('direct_direct_id_seq'::regclass);
...
ALTER TABLE function ALTER COLUMN function_id SET DEFAULT nextval('function_function_id_seq'::regclass);
...
ALTER TABLE language ALTER COLUMN language_id SET DEFAULT nextval('language_language_id_seq'::regclass);
...
ALTER TABLE paper ALTER COLUMN paper_id SET DEFAULT nextval('paper_paper_id_seq'::regclass);
...
ALTER TABLE printer ALTER COLUMN printer_id SET DEFAULT nextval('printer_printer_id_seq'::regclass);
...
ALTER TABLE quality ALTER COLUMN quality_id SET DEFAULT nextval('quality_quality_id_seq'::regclass);
...
ALTER TABLE security_protocol ALTER COLUMN security_protocol_id SET DEFAULT nextval('security_protocol_security_protocol_id_seq'::regclass);
...
ALTER TABLE sheet ALTER COLUMN sheet_id SET DEFAULT nextval('sheet_sheet_id_seq'::regclass);
...
ALTER TABLE so ALTER COLUMN so_id SET DEFAULT nextval('so_so_id_seq'::regclass);
...
ALTER TABLE tag ALTER COLUMN tag_id SET DEFAULT nextval('tag_tag_id_seq'::regclass);
...
ALTER TABLE tecnology ALTER COLUMN tecnology_id SET DEFAULT nextval('tecnology_tecnology_id_seq'::regclass);
...
ALTER TABLE vendor ALTER COLUMN vendor_id SET DEFAULT nextval('vendor_vendor_id_seq'::regclass);
...
COPY printer (printer_id, printer_model, vendor_id, tecnology_id, type_id, printer_conectivities, printer_direct_con, printer_cartridges, printer_functions, printer_papers, printer_velocity, printer_sheet, printer_so, printer_color, printer_duplex, printer_mmdc, printer_vol, printer_tag, printer_link, printer_description, printer_quality_color, printer_valid, printer_languages, printer_memory, printer_lcd, printer_protocols, printer_security_protocols) FROM stdin;
\.
