...
(deffacts the-printer-list
  ...
  (printer (model "HP OfficeJet 4500")(tecnology inyeccion)(type multifuncion)(conectivity usb)(functions imprimir copiar escanear fax)(color si)(duplex no)(minp 350)(maxp 600)(use hogar)(tag economico))
