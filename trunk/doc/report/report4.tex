...
hechos y heurísticas debidamente alamacenadas y un \textit{motor de inferencias} que es el programa 
que gestiona y controla la base de
de conocimiento. 

En un sistema esperto la base de conocimiento y el motor de inferencias se encuentran separados.
...
\subsubsection{Reglas de Producción} 
...
Una encadenamiento que va desde los hechos  hacia un objetivo o conclusión se llama ecadenamiento hacia adelante o \textit{Forward Chain}, 
...
\subsection{Metodología para el desarollo de sistemas expertos}
\smallskip 
...
El motor de inferencias es de tipo Fordward Chaining, y hay varias formas de resolución de conflicto
