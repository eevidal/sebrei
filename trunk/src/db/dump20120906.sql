...
SELECT pg_catalog.setval('paper_paper_id_seq', 7, true);
...
SELECT pg_catalog.setval('printer_printer_id_seq', 16, true);
...
SELECT pg_catalog.setval('sheet_sheet_id_seq', 21, true);
