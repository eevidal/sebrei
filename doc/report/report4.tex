...
Dado que la regla \textbf{adicionales}  hace un assert de todos los sistemas operativos
...
\verb|(assert (so any linux windows mac ))| y agregar una nueva regla que tome alguna decisión 
acerca de cúales sistemas operativos debe soportar los euqipos a recomendar. 
...
Por ejemplo los siguientes tests de prueba:
...
La única diferencia entre la interfaz web y la interfaz para terminal es que en la interfaz web además del modelos de los equipos
